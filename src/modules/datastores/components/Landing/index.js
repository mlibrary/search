    ...
    case 'everything':
      return (
        <div className="landing-container">
          ...
          <p className="datastore-summary">You will see results from the <Link to={`/catalog`}>Catalog</Link>, <Link to={`/articlesplus`}>Articles+</Link>, <Link to={`/databases`}>Databases</Link>, <Link to={`/onlinejournals`}>Online Journals</Link>, and <Link to={`/website`}>Library Website</Link> pages.</p>
        </div>
      )
    case 'mirlyn':
      return (
