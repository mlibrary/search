...
const Icon = ({ name }) => {
  switch (name) {
    ...
    case 'unknown':
    return (<span className="icon" style={{ 'fontWeight': 'bold' }} role="img" aria-label="unknown">🤷</span>)
    default:
    return null
  }
}
