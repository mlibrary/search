  ...
  return (
    <div className='container container-narrow'>
      <main className='container__rounded page'>
        ...
        <p>Library expertise is generated by a separate process; for details, see the &quot;<Anchor href='https://apps.lib.umich.edu/blogs/library-tech-talk/putting-librarians-face-search'>Putting a Librarian&#39;s Face on Search</Anchor>&quot; blog post for an overview.</p>
        <h3>APIs</h3>
        <ul>
          <li>Articles index
            <ul>
        ...
        <p>Most code is available in the <Anchor href='https://github.com/mlibrary/'>University of Michigan Library&#39;s GitHub repository</Anchor> at the following locations:</p>
        <ul>
          <li><Anchor href='https://github.com/mlibrary/search'>Search user interface</Anchor></li>
          <li><Anchor href='https://github.com/mlibrary/pride'>Pride</Anchor></li>
          <li><Anchor href='https://github.com/mlibrary/prejudice'>Prejudice</Anchor></li>
        </ul>
        <p>Updates to these repositories generally summarize the interface or application changes they reflect. There is also a separate, layperson-friendly <Anchor href='https://docs.google.com/document/d/1XTEqXZ9wr1SErU36dd-_XYvrcwrF5tEQwx3dDLeey0Y/edit?usp=sharing'>Library Search Change and Update Log</Anchor>.</p>
      </main>
    </div>
  );
};
