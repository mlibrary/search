  ...
  return (
    <div className='container container-narrow'>
      <main className='page'>
        ...
        <p>Library Search (<a href='https://search.lib.umich.edu/'>https://search.lib.umich.edu/</a>) was built by the <a href='https://lib.umich.edu/about-us/our-divisions-and-departments/library-information-technology/design-and-discovery'>Design &amp; Discovery</a> department at the University of Michigan Library. It was originally based on the <a href='https://github.com/cul/clio-spectrum'>CLIO project</a> from Columbia University, but has evolved significantly into its own application over its two-year development path. It relies on many open source technologies, (<a href='http://lucene.apache.org/solr/'>Solr</a>, <a href='http://projectblacklight.org/'>Blacklight</a>, <a href='https://rubyonrails.org/'>Rails</a>, <a href='https://reactjs.org/'>React.js</a>, <a href='https://citationstyles.org/'>CSL</a>, and many others).</p>
        ...
        <p>For more information about Library Search, please contact <a href='mailto:library-search-feedback@umich.edu'>library-search-feedback@umich.edu</a>.</p>

        <h2>High-Level Schematic</h2>
        <p><img src={schematicImage} alt='' style={{ height: 'auto', maxWidth: '100%' }} /></p>

        <h2>Front-End / User Interface</h2>
        <p>The user interface for Library Search, shown at the top of the above schematic, is a Single Page Application built with <a href='https://reactjs.org/'>React</a> (JavaScript library for building UIs) and developed in-house. It aims to meet the latest <a href='https://www.w3.org/WAI/WCAG21/quickref/?versions=2.1'>WCAG AA Standards</a> and is responsive. Its role is to display the search interface to the user, pass user search queries or other interactions to the Pride and Prejudice middleware components as JSON objects, and format data returned from Pride and Prejudice into what the user sees and interacts with.</p>
        ...
        <p>Library expertise is generated by a separate process; for details, see the &quot;<a href='https://apps.lib.umich.edu/blogs/library-tech-talk/putting-librarians-face-search'>Putting a Librarian&#39;s Face on Search</a>&quot; blog post for an overview.</p>
        ...
        <p>Most code is available in the <a href='https://github.com/mlibrary/'>University of Michigan Library&#39;s GitHub repository</a> at the following locations:</p>
        <ul>
          <li><a href='https://github.com/mlibrary/search'>Search user interface</a></li>
          <li><a href='https://github.com/mlibrary/pride'>Pride</a></li>
          <li><a href='https://github.com/mlibrary/prejudice'>Prejudice</a></li>
        </ul>
        <p>Updates to these repositories generally summarize the interface or application changes they reflect. There is also a separate, layperson-friendly <a href='https://docs.google.com/document/d/1XTEqXZ9wr1SErU36dd-_XYvrcwrF5tEQwx3dDLeey0Y/edit?usp=sharing'>Library Search Change and Update Log</a>.</p>
      </main>
    </div>
  );
};
