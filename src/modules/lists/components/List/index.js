  ...
  const renderList = () => {
    ...
    return (
      <section className='alert'>
        <p><span className='strong'>This list is empty</span>. <Link to={`/${props.datastore.slug}${document.location.search}`}>Go back to {props.datastore.name}</Link> to add to this list.</p>
      </section>
    );
  };
