      ...
      <div className="container container-narrow">
        <article className="page">
          ...
          <section>
            ...
            <p>The U-M Library Search (Mirlyn) Beta lets you search across many of our existing search interfaces in this one tool. We have consolidated: "MLibrary" search, <a className="underline" href="https://mirlyn.lib.umich.edu/">Mirlyn</a>, <a className="underline" href="https://www.lib.umich.edu/searchtools#articlesplus/search">ArticlesPlus</a>, <a className="underline" href="https://www.lib.umich.edu/searchtools#databases/search">Search Tools Databases</a>, and <a className="underline" href="https://www.lib.umich.edu/searchtools#journals/search">Search Tools Journals</a> into this single interface.</p>
